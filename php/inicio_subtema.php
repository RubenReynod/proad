...
session_start();
$consulta="select idnrc,Materias_idMaterias,nombre from nrc,materias where Profesores_idProfesores='".$_SESSION['user']."' and idMaterias=Materias_idMaterias and (select count(*) from unidad where idMateria=idMaterias) > 0";
